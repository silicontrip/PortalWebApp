...
*/
        ...
        {
        	console.log('No portal grabber');
            // should I alert on this?
            alert('MU Grabber requires portal Grabber to submit fields');
            window.plugin.muScraper.muSubmit = false;
        } else {
            window.plugin.muScraper.submitKey = localStorage.getItem('net.silicontrip.ingress.apikey');
            console.log("muGrabber - Getting key: " + window.plugin.muScraper.submitKey);
